        ...
        <nav className="bg-blue-800">
              ...
              <div className="flex md:block hidden sm:items-stretch sm:justify-end">
                <div className="hidden sm:ml-6 sm:block">
                  <div className="flex space-x-4">
                    ...
                    <div className="uppercase text-white hover:bg-white hover:text-blue-500 rounded-md px-3 py-2 text-sm font-medium"><Link href="/markshete">Course</Link></div>
                    <div className="uppercase text-white hover:bg-white hover:text-blue-500 rounded-md px-3 py-2 text-sm font-medium"><Link href="/markshete">Result</Link></div>
                    <div className="uppercase text-white hover:bg-white hover:text-blue-500 rounded-md px-3 py-2 text-sm font-medium"><Link href="/markshete">About</Link></div>
                    <div className="uppercase text-white hover:bg-white hover:text-blue-500 rounded-md px-3 py-2 text-sm font-medium"><Link href="/markshete">Contact</Link></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className={count ? "sm:hidden hidden md-block" : "sm:hidden"} id="mobile-menu">
            <div class="space-y-1 text-center px-2 pb-3 pt-2">              
              ...
              <div className="uppercase text-white hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium"><Link href="/markshete">Result</Link></div>
