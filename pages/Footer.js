            ...
            <footer class="w-full bg-blue-800">
                <div class="mx-auto  ">
                    <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                        <div>
                            <h2 class="mb-6 text-sm font-semibold text-white uppercase">Myruralphsysician</h2>
                    ...
                    <div class="w-full p-4 md:flex md:items-center md:justify-between">
                        <span class="text-white sm:text-center">© 2023 <a href="">Ideaview</a>. All Rights Reserved.
                        </span>
